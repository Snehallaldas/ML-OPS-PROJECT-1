...
class ModelTraining:
    ...
    def load_and_split_data(self):
        try:
            ...
            logger.info("Loading data for {self.test_path}")
            ...
            logger.error(f"Error while loading our data {e}")
    ...
    def train_lgbm(self,X_train,y_train):
        try:
            ...
            logger.info("Starting our Hyperperameter tuning")
    ...
    def evaluate_model(self, model, X_test, y_test):
        try:
            ...
            logger.info(f"Recall Scorev : {recall}")
            logger.info(f"F! Score : {f1}")
    ...
    def save_model(self,model):
        try:
            ...
            logger.error(f"Exceptin while saving model {e}")
    ...
    def run(self):
        try:
            ...
            raise CustomException("failed during model training pipieline", e)
